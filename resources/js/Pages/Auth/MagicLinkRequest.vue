<template>
  ...
  <GuestLayout>
    ...
    <div class="bg-white/80 dark:bg-gray-800/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 dark:border-gray-700/50 p-8">
      ...
      <div class="space-y-6">
      <!-- Success Message -->
      <div v-if="status || linkSent" class="rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 dark:from-green-900/30 dark:to-emerald-900/30 p-4 border border-green-200 dark:border-green-800/50">
        <div class="flex">
          ...
          <div class="ml-3">
            <h3 class="text-sm font-medium text-green-800 dark:text-green-300">Check your email!</h3>
      ...
      <!-- Error Message -->
      <div v-if="form.errors.email" class="rounded-xl bg-gradient-to-r from-red-50 to-pink-50 dark:from-red-900/30 dark:to-pink-900/30 p-4 border border-red-200 dark:border-red-800/50">
        <div class="flex">
          <div class="flex-shrink-0">
          ...
          <div class="ml-3">
            <p class="text-sm font-medium text-red-800 dark:text-red-300">{{ form.errors.email }}</p>
          </div>
        </div>
      </div>
      ...
      <div class="text-center">
        <Link
          :href="route('login')"
          class="inline-flex items-center text-sm font-medium text-indigo-600 dark:text-indigo-400 hover:text-purple-600 dark:hover:text-purple-400 transition-colors"
        >
