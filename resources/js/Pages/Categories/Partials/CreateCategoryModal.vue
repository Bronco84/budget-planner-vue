...
const submit = () => {
    form.post(route('budgets.categories.store', props.budget.id), {
        preserveScroll: true,
        onSuccess: () => {
            closeModal();
        },
    ...
    <Modal :show="show" @close="closeModal" max-width="lg">
        <div class="p-6">
            ...
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                Add a new category to track spending in <span class="font-medium">{{ budget.name }}</span>
            </p>
            ...
            <form @submit.prevent="submit" class="mt-6">
                <div class="space-y-4">
                    ...
                    <!-- Amount -->
                    <div>
                        <InputLabel for="amount" value="Allocated Amount" />
