        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
          <form @submit.prevent="submit" class="p-6 space-y-6">
            ...
            <div v-if="liabilityAccounts.length > 0" class="border-t border-gray-200 dark:border-gray-700 pt-4">
              <label for="linked_account" class="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Link to Loan Account (Optional)
              </label>
              <select
                id="linked_account"
...
const submit = () => {
  form.post(route('budgets.properties.store', props.budget.id));
};
</script>
