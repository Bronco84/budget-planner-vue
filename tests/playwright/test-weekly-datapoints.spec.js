...
test('verify weekly data points in scenarios', async ({ page }) => {
  // Login
  ...
  await page.screenshot({ 
    path: 'tests/playwright/screenshots/weekly-datapoints.png',
    fullPage: true
  });
  
  console.log('Screenshot saved - chart should show weekly data points');
});
